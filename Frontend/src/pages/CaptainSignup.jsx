...
export const CaptainSignup = () => {
  ...
  <p className="text-[10px] sm:text-xs px-6 text-center leading-tight mb-5 max-w-[90%] mx-auto">This site is protected by reCAPTCHA and the <span className='underline'>Google Policy</span> and <span className='underline'>Terms of Service apply</span>
